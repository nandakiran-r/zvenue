...
export const CATEGORIES = [
  { id: '1', name: 'Music', icon: 'music-note' },
  { id: '2', name: 'Education', icon: 'school' },
  { id: '3', name: 'Film & Media', icon: 'movie' },
  { id: '4', name: 'Food & Drink', icon: 'restaurant' },
  { id: '5', name: 'Sport', icon: 'sports-soccer' },
  { id: '6', name: 'Party', icon: 'celebration' },
];

export const FAVOURITE_CATEGORIES = [
  { id: '1', name: 'Business', icon: 'business' },
  { id: '2', name: 'Community', icon: 'people' },
  { id: '3', name: 'Music & Entertainment', icon: 'music-note' },
  { id: '4', name: 'Health', icon: 'favorite' },
  { id: '5', name: 'Food & drink', icon: 'restaurant' },
  { id: '6', name: 'Family & Education', icon: 'family-restroom' },
  { id: '7', name: 'Sport', icon: 'sports-soccer' },
  { id: '8', name: 'Fashion', icon: 'checkroom' },
  { id: '9', name: 'Film & Media', icon: 'movie' },
  { id: '10', name: 'Home & Lifestyle', icon: 'home' },
  { id: '11', name: 'Design', icon: 'palette' },
  { id: '12', name: 'Gaming', icon: 'sports-esports' },
  { id: '13', name: 'Science & Tech', icon: 'science' },
  { id: '14', name: 'School & Education', icon: 'school' },
  { id: '15', name: 'Holiday', icon: 'celebration' },
  { id: '16', name: 'Travel', icon: 'flight' },
];
