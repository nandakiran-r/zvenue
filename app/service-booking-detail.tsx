...
const styles = StyleSheet.create({
  ...
  // Calendar
  calendarCard: { backgroundColor: Colors.white, borderRadius: 16, padding: 16, marginBottom: 20, shadowColor: "#000", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.05, shadowRadius: 8, elevation: 2 },
  ...
  calCellTextBooked: { color: "#FF9800" },
  bookedDot: { width: 4, height: 4, borderRadius: 2, backgroundColor: "#FF9800", marginTop: 2 },
